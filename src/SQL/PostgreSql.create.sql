...
CREATE INDEX Index52e78a286299ec0faa67b4f751a6cda2dec1a57a on Сотрудник (Должность); 
 ...
 ALTER TABLE РегистрЗаписи ADD CONSTRAINT FK03115f3229fc6dc3693fe23d8b54bd409a979523 FOREIGN KEY (Запись) REFERENCES Запись; 
CREATE INDEX Index03115f3229fc6dc3693fe23d8b54bd409a979523 on РегистрЗаписи (Запись); 
