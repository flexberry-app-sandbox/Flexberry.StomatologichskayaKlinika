...
namespace IIS.Stomatologichskaya_klinika
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomatologichskaya_klinika.DetailArrayOfДокументы fДокументы;
        ...
        public virtual IIS.Stomatologichskaya_klinika.DetailArrayOfДокументы Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new IIS.Stomatologichskaya_klinika.DetailArrayOfДокументы(this);
                }
                IIS.Stomatologichskaya_klinika.DetailArrayOfДокументы result = this.fДокументы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Stomatologichskaya_klinika.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Stomatologichskaya_klinika.Клиент));
                }
            }
        }
    }
