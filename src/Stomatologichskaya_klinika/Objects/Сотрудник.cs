...
namespace IIS.Stomatologichskaya_klinika
{
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomatologichskaya_klinika.Должность fДолжность;
        ...
        [PropertyStorage(new string[] {
                "Должность"})]
        [NotNull()]
        public virtual IIS.Stomatologichskaya_klinika.Должность Должность
        {
            get
            {
                ...
                IIS.Stomatologichskaya_klinika.Должность result = this.fДолжность;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.Stomatologichskaya_klinika.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.Stomatologichskaya_klinika.Сотрудник));
                }
            }
        }
    }
