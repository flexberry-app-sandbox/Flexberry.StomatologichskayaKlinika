    ...
    public class Кабинет : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КабинетE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КабинетE", typeof(IIS.Stomatologichskaya_klinika.Кабинет));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КабинетL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КабинетL", typeof(IIS.Stomatologichskaya_klinika.Кабинет));
                }
            }
        }
    }
