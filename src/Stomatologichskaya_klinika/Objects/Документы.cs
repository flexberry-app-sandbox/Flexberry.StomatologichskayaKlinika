...
namespace IIS.Stomatologichskaya_klinika
{
    ...
    public class Документы : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Stomatologichskaya_klinika.Клиент.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументыE", typeof(IIS.Stomatologichskaya_klinika.Документы));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДокументы : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Stomatologichskaya_klinika.DetailArrayOfДокументы members)

        // *** End programmer edit section *** (IIS.Stomatologichskaya_klinika.DetailArrayOfДокументы members)
        ...
        /// </summary>
        public DetailArrayOfДокументы(IIS.Stomatologichskaya_klinika.Клиент fКлиент) : 
                base(typeof(Документы), ((ICSSoft.STORMNET.DataObject)(fКлиент)))
        {
        }
        
        public IIS.Stomatologichskaya_klinika.Документы this[int index]
        {
            get
            {
                return ((IIS.Stomatologichskaya_klinika.Документы)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Stomatologichskaya_klinika.Документы dataobject)
        {
