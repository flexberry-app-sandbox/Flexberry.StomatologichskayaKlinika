...
namespace IIS.Stomatologichskaya_klinika
{
    ...
    public class Запись : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomatologichskaya_klinika.Клиент fКлиент;
        
        private IIS.Stomatologichskaya_klinika.Кабинет fКабинет;
        
        private IIS.Stomatologichskaya_klinika.DetailArrayOfОказаниеУслуг fОказаниеУслуг;
        ...
        [PropertyStorage(new string[] {
                "Кабинет"})]
        [NotNull()]
        public virtual IIS.Stomatologichskaya_klinika.Кабинет Кабинет
        {
            get
            {
                ...
                IIS.Stomatologichskaya_klinika.Кабинет result = this.fКабинет;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Stomatologichskaya_klinika.Клиент Клиент
        {
            get
            {
                ...
                IIS.Stomatologichskaya_klinika.Клиент result = this.fКлиент;
        ...
        public virtual IIS.Stomatologichskaya_klinika.DetailArrayOfОказаниеУслуг ОказаниеУслуг
        {
            get
            {
                ...
                {
                    this.fОказаниеУслуг = new IIS.Stomatologichskaya_klinika.DetailArrayOfОказаниеУслуг(this);
                }
                IIS.Stomatologichskaya_klinika.DetailArrayOfОказаниеУслуг result = this.fОказаниеУслуг;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьE", typeof(IIS.Stomatologichskaya_klinika.Запись));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаписьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьL", typeof(IIS.Stomatologichskaya_klinika.Запись));
                }
            }
        }
    }
