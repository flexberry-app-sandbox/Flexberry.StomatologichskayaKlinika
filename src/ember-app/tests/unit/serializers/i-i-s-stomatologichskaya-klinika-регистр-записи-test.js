...
moduleForModel('i-i-s-stomatologichskaya-klinika-регистр-записи', 'Unit | Serializer | i-i-s-stomatologichskaya-klinika-регистр-записи', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologichskaya-klinika-регистр-записи',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
