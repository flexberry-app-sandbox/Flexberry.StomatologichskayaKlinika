...
moduleForModel('i-i-s-stomatologichskaya-klinika-производитель', 'Unit | Serializer | i-i-s-stomatologichskaya-klinika-производитель', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologichskaya-klinika-производитель',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
