...
moduleForModel('i-i-s-stomatologichskaya-klinika-документы', 'Unit | Serializer | i-i-s-stomatologichskaya-klinika-документы', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologichskaya-klinika-документы',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
