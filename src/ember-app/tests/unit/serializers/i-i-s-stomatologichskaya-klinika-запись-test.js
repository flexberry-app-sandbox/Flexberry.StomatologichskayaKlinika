...
moduleForModel('i-i-s-stomatologichskaya-klinika-запись', 'Unit | Serializer | i-i-s-stomatologichskaya-klinika-запись', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologichskaya-klinika-запись',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
