...
moduleForModel('i-i-s-stomatologichskaya-klinika-должность', 'Unit | Serializer | i-i-s-stomatologichskaya-klinika-должность', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologichskaya-klinika-должность',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
