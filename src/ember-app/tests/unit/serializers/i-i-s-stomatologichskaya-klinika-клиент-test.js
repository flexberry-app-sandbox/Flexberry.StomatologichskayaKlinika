...
moduleForModel('i-i-s-stomatologichskaya-klinika-клиент', 'Unit | Serializer | i-i-s-stomatologichskaya-klinika-клиент', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologichskaya-klinika-клиент',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
