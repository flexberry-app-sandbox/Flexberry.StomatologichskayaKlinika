...
moduleForModel('i-i-s-stomatologichskaya-klinika-сотрудник', 'Unit | Serializer | i-i-s-stomatologichskaya-klinika-сотрудник', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-stomatologichskaya-klinika-сотрудник',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
