...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologichskaya klinika должность l');

test('testing i-i-s-stomatologichskaya-klinika-должность-l', function(assert) {
