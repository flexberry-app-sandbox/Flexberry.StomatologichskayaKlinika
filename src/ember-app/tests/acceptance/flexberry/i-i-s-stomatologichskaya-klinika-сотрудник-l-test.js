...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologichskaya klinika сотрудник l');

test('testing i-i-s-stomatologichskaya-klinika-сотрудник-l', function(assert) {
