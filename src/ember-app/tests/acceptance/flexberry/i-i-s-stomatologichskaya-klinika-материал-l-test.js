...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologichskaya klinika материал l');

test('testing i-i-s-stomatologichskaya-klinika-материал-l', function(assert) {
