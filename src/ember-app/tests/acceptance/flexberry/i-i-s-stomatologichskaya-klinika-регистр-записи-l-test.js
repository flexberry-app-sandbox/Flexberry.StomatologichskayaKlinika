...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologichskaya klinika регистр записи l');

test('testing i-i-s-stomatologichskaya-klinika-регистр-записи-l', function(assert) {
