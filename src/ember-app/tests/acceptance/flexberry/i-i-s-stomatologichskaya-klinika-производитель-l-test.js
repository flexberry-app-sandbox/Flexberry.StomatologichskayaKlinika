...
moduleForAcceptance('[AGAT] Acceptance | i i s stomatologichskaya klinika производитель l');

test('testing i-i-s-stomatologichskaya-klinika-производитель-l', function(assert) {
